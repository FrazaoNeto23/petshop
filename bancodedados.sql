...
-- Inserir: usuarios
INSERT INTO
    usuarios (nome, email, senha, ativo)
VALUES
    (
        'Administrador',
        'admin@petshop.com',
        '$2y$10$fPJWOc0KWoFN6BdCw.yz2.4PRaxRtnSy4iHDxR2fjKI3pkBVymqna',
        1
    ),
    (
        'Gerente',
        'gerente@petshop.com',
        '$2y$10$7Csw8NcBXKmEKQQEpoMjc.z4ONLpBy2NyGl5mseFCL7ZJUFrbjh3W',
        1
    ),
    (
        'Vendedor',
        'vendedor@petshop.com',
        '$2y$10$tG/GxNkKc.3mIIsyCEb/YOucrGsmlcTbk2b.acrRJnIcEJN56oKmu',
        1
    );
...
VALUES
    ...
    (
        'BRI001',
        'Bolinha de Borracha Resistente',
        3,
        32.90,
        0,
        20
